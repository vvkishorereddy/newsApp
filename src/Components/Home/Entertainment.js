...
class Entertainment extends Component {
  ...
  componentDidMount() {
    fetch(
      "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=829625f069434caa944d60c7cf0b8c65"
    )
  ...
  render() {
    ...
    return (
      <View>
        <Text style={styles.heading}>Latest Entertainment News</Text>
